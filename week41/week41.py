...
beta_moment = GradientDescent(X_train, y_train, n_iter = iterations, method = 'OLS', momentum = momentum)
beta_Ridge_moment = GradientDescent(X_train, y_train, n_iter = iterations, method = 'Ridge', momentum = momentum)
